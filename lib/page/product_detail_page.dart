...
class _ProductDetailPageState extends State<ProductDetailPage> {
  ...
  Positioned buildbottomPositioned(ProductDetailModel model) {
    return Positioned(
      left: 0,
      right: 0,
      bottom: 0,
  ...
  Container buildCountContainer(
    ...
    return Container(
      ...
      child: InkWell(
        ...
        onTap: () {
          // 选择商品个数
          showGoodsCount(provider, model);
        },
      ),
    );
  }

  Future showGoodsCount(
      ProductDetailProvider provider, ProductDetailModel model) {
